...
class PrestashopSupplier(models.Model):
    ...
    _description = "Supplier prestashop bindings: suppliers"
    ...
    def import_suppliers(self, backend, since_date, **kwargs):
        ...
        self.env['prestashop.supplier'].with_delay(
            description=f"Prepare Batch import Suppplier with filters {filters}",
...
class PrestashopProductSupplierinfo(models.Model):
    ...
    _description = "Product supplierinfo prestashop bindings: product_suppliers"
...
class SupplierBinder(Component):
    _name = 'prestashop.supplier.binder'
    _inherit = 'prestashop.binder'
    _apply_on = 'prestashop.supplier'


class SupplierInfoBinder(Component):
    _name = 'prestashop.product.supplierinfo.binder'
    _inherit = 'prestashop.binder'
    _apply_on = 'prestashop.product.supplierinfo'
