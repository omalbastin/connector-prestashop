...
class RefundImporter(Component):
    ...
    def _open_refund(self, binding):
        ...
        if invoice.amount_total == (
            ...
            invoice.message_post(message=_(
...
class RefundMatchImporter(Component):
    _name = 'prestashop.refund.match.importer'
    _inherit = 'prestashop.match.importer'
    _apply_on = 'prestashop.refund'


class RefundBatchMatchImporter(Component):
    _name = 'prestashop.refund.batch.match.importer'
