...
class PrestashopPartnerMixin(models.AbstractModel):
    ...
    _description = "Prestashop partner mixin"
...
class PrestashopResPartner(models.Model):
    ...
    _description = "prestashop customers"
    ...
    def import_customers_since(self, backend_record=None, since_date=None,
        ...
        self.env['prestashop.res.partner.category'].import_batch_merge(
            backend=backend_record, filters=filters, priority=10, **kwargs)
        self.env['prestashop.res.partner'].import_batch_merge(
...
class PrestashopAddressMixin(models.AbstractModel):
    ...
    _description = "Prestashop address mixin"
...
class PrestashopAddress(models.Model):
    ...
    _inherits = {'res.partner': 'odoo_id'}
    _rec_name = 'odoo_id'
    _description = "prestashop addresses"
...
class PartnerBinder(Component):
    _name = 'prestashop.res.partner.binder'
...
class PartnerAddressBinder(Component):
    _name = 'prestashop.address.binder'
    _inherit = 'prestashop.binder'
    _apply_on = 'prestashop.address'
