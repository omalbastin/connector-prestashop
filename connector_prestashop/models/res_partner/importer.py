...
class ResPartnerImporter(Component):
    ...
    def _after_import(self, binding):
        ...
        self.env['prestashop.address'].import_batch_merge(
            self.backend_record,
...
class PartnerMatchImporter(Component):
    _name = 'prestashop.res.partner.match.importer'
    _inherit = 'prestashop.match.importer'
    _apply_on = 'prestashop.res.partner'
    _no_matching_needed = True
    _update_with_ps_values = True


class PartnerMatchBatchImporter(Component):
    _name = 'prestashop.res.partner.match.batch.importer'
...
class AddressMatchImporter(Component):
    _name = 'prestashop.address.match.importer'
    _inherit = 'prestashop.match.importer'
    _apply_on = 'prestashop.address'
    _no_matching_needed = True
    _update_with_ps_values = True
...
class AddressMatchBatchImporter(Component):
    _name = 'prestashop.address.match.batch.importer'
    _inherit = 'prestashop.batch.match.importer'
    _apply_on = 'prestashop.address'
