...
class VersionKey1612(Component):
    ...
    keys = {
        ...
        'group': 'group',
        'order_row': 'order_row',
        'tax': 'tax',  # it was taxes, but in 1.6.1.5 i get was tax
...
class VersionKey1742(Component):
    _name = '_prestashop.version.key.1.7.4.2'
    _inherit = '_prestashop.version.key'
    _usage = 'prestashop.version.key.1.7.4.2'
...
class VersionKey81(Component):
    _name = '_prestashop.version.key.8.1'
    _inherit = '_prestashop.version.key'
    _usage = 'prestashop.version.key.8.1'
